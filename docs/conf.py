...
from litestar_socketify.__metadata__ import __project__ as project
from litestar_socketify.__metadata__ import __version__ as version
...
author = "Cody Fincher"
release = version
release = os.getenv("_LITESTAR-SOCKETIFY_DOCS_BUILD_VERSION", version.rsplit(".")[0])
...
html_theme_options = {
    ...
    "github_url": "https://github.com/cofin/litestar-socketify",
    "nav_links": [
        {"title": "Home", "url": "https://cofin.github.io/litesatr-socketify/"},
        {"title": "Docs", "url": "https://cofin.github.io/litesatr-socketify/latest/"},
        {"title": "Code", "url": "https://github.com/cofin/litestar-socketify"},
    ],
    "light_css_variables": {
        # RGB
